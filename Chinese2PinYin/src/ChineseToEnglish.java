...
public class ChineseToEnglish {
	 public static void main(String[] args) {  
	        System.out.println(getPingYin("鄢新疆傻傻的原来绿"
	        		+ ""));  
	        System.out.println(getPinYinHeadChar("鄢新疆傻傻原来"));
	        
	        System.out.println(getCnASCII("鄢"));
	        System.out.println(getPinYinShengMu("鄢新疆傻傻的原来绿"));
	        System.out.println(getPinYinTone("鄢新疆傻傻的原来绿"));
	        System.out.println(getPinYinLastYunMu("裁剪冰绡"));
	        System.out.println(getPinYinYunMu("裁剪冰绡"));
	    } 
    ...
    public static String getPinYinYunMu(String str) {
    	...
    	for(int i=0;i<str.length();i++){
    		String oneWord=str.substring(i, i+1);
    		String oneWordStr=getPingYinNoTone(oneWord);
            String oneWordshengMu=getPinYinShengMu(oneWord);
            String oneWordYunMu=oneWordStr.replaceAll(oneWordshengMu, "");
            YunMu+=oneWordYunMu; 
    	}
    	return YunMu;
